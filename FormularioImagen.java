...
public class FormularioImagen {
    ...
    public static void main(String[] args) {
        ...
        // Cargar la imagen
        String rutaImagen = "C:\\Users\\user\\OneDrive\\Escritorio\\Familia.jpg";
        ...
        exerciseThread.waitForAnswer("2. Jason and Emily are their ________  ", "children");
        exerciseThread.evaluateAnswer("children");


        exerciseThread.waitForAnswer("3. Paul is Anne's ________  ", "husband");
        exerciseThread.evaluateAnswer("husband");


        exerciseThread.waitForAnswer("4. Jason is Anne´s ________  ", "son");
        exerciseThread.evaluateAnswer("son");


        exerciseThread.waitForAnswer("5. Emily is Paul´s ________  ", "daughter");
        exerciseThread.evaluateAnswer("daughter");


        exerciseThread.waitForAnswer("6. Jason is Emily´s ________  ", "brother");
        exerciseThread.evaluateAnswer("brother");


        exerciseThread.waitForAnswer("7. Emily is Jason´s ________ ", "sister");
        exerciseThread.evaluateAnswer("sister");


        exerciseThread.waitForAnswer("8. Paul and Anne are Jason´s ________  ", "parents");
